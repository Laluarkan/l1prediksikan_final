  ...
  return (
    <div className="bg-slate-900 min-h-screen pb-12 md:pb-24 overflow-hidden">
      ...
      <section className="relative w-full min-h-[65vh] md:min-h-[85vh] flex items-center justify-center text-center px-4 md:px-6 border-b border-slate-800">
        ...
        <div className={`relative z-10 max-w-5xl mx-auto transition-all duration-1000 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} mt-8 md:mt-0`}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 px-4 max-w-xs sm:max-w-none mx-auto">
            <Link href="/fixtures" className="group relative inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 md:px-8 md:py-4 rounded-xl font-bold transition-all shadow-[0_0_15px_rgba(37,99,235,0.4)] hover:shadow-[0_0_25px_rgba(37,99,235,0.6)] text-xs md:text-base w-full sm:w-auto">
              Lihat Fixtures 
              <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform md:w-[18px] md:h-[18px]" />
            </Link>
            <Link href="/history" className="inline-flex items-center justify-center bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 px-5 py-2.5 md:px-8 md:py-4 rounded-xl font-bold transition-colors text-xs md:text-base w-full sm:w-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 md:space-y-32 -mt-6 md:-mt-16 relative z-20">
        ...
        <section className={`grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 transition-all duration-1000 delay-300 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-3 md:p-6 rounded-xl md:rounded-2xl text-center shadow-xl">
            <h3 className="text-xl md:text-4xl font-extrabold text-white mb-1"><AnimatedCounter end={11} /></h3>
            <p className="text-[9px] md:text-xs text-slate-400 uppercase tracking-widest font-semibold">Liga Eropa</p>
          </div>
          <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-3 md:p-6 rounded-xl md:rounded-2xl text-center shadow-xl">
            <h3 className="text-xl md:text-4xl font-extrabold text-white mb-1"><AnimatedCounter end={25000} suffix="+" /></h3>
            <p className="text-[9px] md:text-xs text-slate-400 uppercase tracking-widest font-semibold">Match Dianalisis</p>
          </div>
          <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-3 md:p-6 rounded-xl md:rounded-2xl text-center shadow-xl">
            <h3 className="text-xl md:text-4xl font-extrabold text-white mb-1"><AnimatedCounter end={68} suffix="%" /></h3>
          ...
          <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-3 md:p-6 rounded-xl md:rounded-2xl text-center shadow-xl relative overflow-hidden group">
            ...
            <h3 className="text-xl md:text-4xl font-extrabold text-white mb-1"><AnimatedCounter end={24} suffix="/7" /></h3>
          ...
          {hotFixtures.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
              {hotFixtures.map((fixture) => (
                <div key={fixture.id} className="bg-slate-800 border border-slate-700 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-slate-500 transition-colors group cursor-default">
                  <div className="flex justify-between items-center mb-3 md:mb-4">
                    <span className="text-[9px] md:text-xs font-medium text-slate-400 bg-slate-900 px-2 md:px-3 py-1 rounded-full">{fixture.league_name}</span>
                  ...
                  <div className="flex flex-col space-y-1 mb-4 md:mb-6">
                    <div className="text-sm md:text-lg font-bold text-white group-hover:text-blue-400 transition-colors truncate">{fixture.home_team_name}</div>
                    <div className="text-[9px] md:text-xs text-slate-500 uppercase font-semibold">vs</div>
                    <div className="text-sm md:text-lg font-bold text-white group-hover:text-blue-400 transition-colors truncate">{fixture.away_team_name}</div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-8">
            <div className="group relative">
              ...
              <div className="relative bg-slate-800 border border-slate-700 p-5 md:p-8 rounded-xl md:rounded-2xl h-full flex flex-col items-start">
                <div className="p-2 md:p-3 bg-slate-900 rounded-lg mb-3 md:mb-6"><Crosshair className="text-blue-400 w-5 h-5 md:w-6 md:h-6" /></div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-slate-800 border border-slate-700 p-5 md:p-8 rounded-xl md:rounded-2xl h-full flex flex-col items-start">
                <div className="p-2 md:p-3 bg-slate-900 rounded-lg mb-3 md:mb-6"><Zap className="text-purple-400 w-5 h-5 md:w-6 md:h-6" /></div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-slate-800 border border-slate-700 p-5 md:p-8 rounded-xl md:rounded-2xl h-full flex flex-col items-start">
                <div className="p-2 md:p-3 bg-slate-900 rounded-lg mb-3 md:mb-6"><ShieldCheck className="text-emerald-400 w-5 h-5 md:w-6 md:h-6" /></div>
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-xl md:rounded-3xl p-1 relative overflow-hidden">
          ...
          <div className="relative z-10 bg-slate-800/40 backdrop-blur border border-slate-700/50 p-5 md:p-12 rounded-[10px] md:rounded-[22px]">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 md:mb-10 border-b border-slate-700/50 pb-5 md:pb-8">
              ...
              <Link href="/performance" className="w-full md:w-auto bg-slate-700 hover:bg-slate-600 text-white text-[10px] md:text-sm px-6 py-3 rounded-xl transition-colors text-center font-semibold">
              ...
              {!perfData ? (
                ...
                <>
                  <div className="bg-slate-900/80 border border-slate-700 p-4 md:p-6 rounded-lg md:rounded-2xl">
                    <div className="text-[9px] md:text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 md:mb-4">Total Return FTR</div>
                    <div className={`text-xl md:text-3xl font-mono font-bold flex items-center ${perfData.ftr.unit_profit >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {perfData.ftr.unit_profit >= 0 ? '+' : ''}{perfData.ftr.unit_profit.toFixed(2)} <span className="text-[10px] md:text-sm text-slate-500 ml-2">Units</span>
                    </div>
                    <div className="mt-2 md:mt-4 w-full bg-slate-800 rounded-full h-1 md:h-1.5 overflow-hidden">
                      <div className="bg-emerald-500 h-1 md:h-1.5 rounded-full" style={{ width: `${(perfData.ftr.wins / (perfData.ftr.wins + perfData.ftr.losses)) * 100}%` }}></div>
                    </div>
                  </div>
                  
                  <div className="bg-slate-900/80 border border-slate-700 p-4 md:p-6 rounded-lg md:rounded-2xl">
                    <div className="text-[9px] md:text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 md:mb-4">Total Return O/U</div>
                    <div className={`text-xl md:text-3xl font-mono font-bold flex items-center ${perfData.ou.unit_profit >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {perfData.ou.unit_profit >= 0 ? '+' : ''}{perfData.ou.unit_profit.toFixed(2)} <span className="text-[10px] md:text-sm text-slate-500 ml-2">Units</span>
                    </div>
                    <div className="mt-2 md:mt-4 w-full bg-slate-800 rounded-full h-1 md:h-1.5 overflow-hidden">
                      <div className="bg-emerald-500 h-1 md:h-1.5 rounded-full" style={{ width: `${(perfData.ou.wins / (perfData.ou.wins + perfData.ou.losses)) * 100}%` }}></div>
                    </div>
                  </div>
                  
                  <div className="bg-slate-900/80 border border-slate-700 p-4 md:p-6 rounded-lg md:rounded-2xl">
                    <div className="text-[9px] md:text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 md:mb-4">Total Return Parlay</div>
                    <div className={`text-xl md:text-3xl font-mono font-bold flex items-center ${perfData.parlay.unit_profit >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {perfData.parlay.unit_profit >= 0 ? '+' : ''}{perfData.parlay.unit_profit.toFixed(2)} <span className="text-[10px] md:text-sm text-slate-500 ml-2">Units</span>
                    </div>
